...
<p>São aquelas que retornam uma nova Stream e permitem encadear várias operações, formando um pipeline de processamento de dados. São elas:</p>
...
<p>São aquelas que encerram o pipeline e produzem um resultado final. São elas:</p>
